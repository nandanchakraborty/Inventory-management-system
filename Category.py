...
class CategoryClass:
    ...
    def __init__(self, r):
        ...
        lbl_name = (Label(self.root, text="Enter Category Name", font=employee_form_font, bg="white")
                    .place(x=50, y=100))

        lbl_name = (Entry(self.root, textvariable=self.var_name, font=employee_form_font, bg="lightyellow")
                    .place(x=50, y=150, width=300))

        btn_add = (Button(self.root, text="Add", command=self.add, font=employee_form_font, bg="#4caf50", fg="white",
                          cursor="hand2")
                   .place(x=360, y=155, width=150, height=30))

        btn_delete = (
            Button(self.root, text="Delete", command=self.delete, font=employee_form_font, bg="Red", fg="white",
                   cursor="hand2")
            .place(x=520, y=155, width=150, height=30))
