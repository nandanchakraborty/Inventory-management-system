...
class BillClass:
    def __init__(self, r):
        ...
        self.lbl_clock = Label(self.root,
                               text="Welcome to Inventory Management System\t\t Date: DD-YYYY\t\t Time: HH:MM:SS",
        ...
        pTitle = (
            Label(ProductFrame1, text="All Products", font=("goudy old style", 20, "bold"), bg="#262626", fg="white")
        ...
        lbl_search = (
            Label(ProductFrame2, text="Search Product | By Name", font=("times new roman", 15, "bold"), bg="white",
                  fg="green")
            .place(x=2, y=5))
        ...
        btn_search = (
            Button(ProductFrame2, text="Search", command=self.search, font=("goudy old style", 15), bg="#2196f3",
                   fg="white", cursor="hand2")
            .place(x=285, y=45, width=100, height=25))
        btn_show_all = (
            Button(ProductFrame2, text="Show All", command=self.show, font=("goudy old style", 15), bg="#083531",
                   fg="white", cursor="hand2")
        ...
        cTitle = (Label(CustomerFrame, text="Customer Details", font=("goudy old style", 15,), bg="light gray")
                  .pack(side=TOP, fill=X))
        ...
        lbl_contact = (Label(CustomerFrame, text=" Contact No.", font=("times new roman", 15,), bg="white")
                       .place(x=270, y=35))
        txt_contact = (
            Entry(CustomerFrame, textvariable=self.var_contact, font=("times new roman", 13), bg="lightyellow")
        ...
        Cal_Frame.place(x=5, y=10, width=580, height=340)

        txt_cal_input = Entry(Cal_Frame, textvariable=self.var_cal_input, font=('ariel', 15, 'bold'), width=18, bd=10,
                              relief=GROOVE, state="readonly", justify=RIGHT)
        txt_cal_input.grid(row=0, columnspan=4)

        btn_7 = (
            Button(Cal_Frame, text='7', font=('ariel', 15, 'bold'), command=lambda: self.get_input(7), bd=5, width=2,
                   pady=10, cursor="hand2")
            .grid(row=1, column=0))
        btn_8 = (
            Button(Cal_Frame, text='8', font=('ariel', 15, 'bold'), command=lambda: self.get_input(8), bd=5, width=2,
                   pady=10, cursor="hand2")
            .grid(row=1, column=1))
        btn_9 = (
            Button(Cal_Frame, text='9', font=('ariel', 15, 'bold'), command=lambda: self.get_input(9), bd=5, width=2,
                   pady=10, cursor="hand2")
            .grid(row=1, column=2))
        btn_sum = (
            Button(Cal_Frame, text='+', font=('ariel', 15, 'bold'), command=lambda: self.get_input('+'), bd=5, width=2,
                   pady=10, cursor="hand2")
            .grid(row=1, column=3))

        btn_4 = (Button(Cal_Frame, text='4', font=('ariel', 15, 'bold'), command=lambda: self.get_input(4), bd=5,
                        width=2, pady=10, cursor="hand2")
                 .grid(row=2, column=0))
        btn_5 = (
            Button(Cal_Frame, text='5', font=('ariel', 15, 'bold'), command=lambda: self.get_input(5), bd=5, width=2,
                   pady=10, cursor="hand2")
            .grid(row=2, column=1))
        btn_6 = (
            Button(Cal_Frame, text='6', font=('ariel', 15, 'bold'), command=lambda: self.get_input(6), bd=5, width=2,
                   pady=10, cursor="hand2")
            .grid(row=2, column=2))
        btn_sub = (
            Button(Cal_Frame, text='-', font=('ariel', 15, 'bold'), command=lambda: self.get_input('-'), bd=5, width=2,
        ...
        btn_1 = (
            Button(Cal_Frame, text='1', font=('ariel', 15, 'bold'), command=lambda: self.get_input(1), bd=5, width=2,
                   pady=10, cursor="hand2")
            .grid(row=3, column=0))
        btn_2 = (
            Button(Cal_Frame, text='2', font=('ariel', 15, 'bold'), command=lambda: self.get_input(2), bd=5, width=2,
                   pady=10, cursor="hand2")
            .grid(row=3, column=1))
        btn_3 = (
            Button(Cal_Frame, text='3', font=('ariel', 15, 'bold'), command=lambda: self.get_input(3), bd=5, width=2,
                   pady=10, cursor="hand2")
            .grid(row=3, column=2))
        btn_mul = (
            Button(Cal_Frame, text='*', font=('ariel', 15, 'bold'), command=lambda: self.get_input('*'), bd=5, width=2,
        ...
        btn_0 = (
            Button(Cal_Frame, text='0', font=('ariel', 15, 'bold'), command=lambda: self.get_input(0), bd=5, width=2,
                   pady=15, cursor="hand2")
            .grid(row=4, column=0))
        btn_c = (Button(Cal_Frame, text='C', font=('ariel', 15, 'bold'), command=self.clear_cal, bd=5, width=2, pady=15,
                        cursor="hand2")
                 .grid(row=4, column=1))
        btn_equal = (
            Button(Cal_Frame, text='=', font=('ariel', 15, 'bold'), command=self.perform_cal, bd=5, width=2, pady=15,
                   cursor="hand2")
            .grid(row=4, column=2))
        btn_div = (
            Button(Cal_Frame, text='/', font=('ariel', 15, 'bold'), command=lambda: self.get_input('/'), bd=5, width=2,
        ...
        btn_clear_cart = (
            Button(Add_CartWidgetsFrame, text="Clear", font=("times new roman", 15, "bold"), command=self.clear_cart,
                   bg="lightgrey", cursor="hand2")
            .place(x=180, y=70, width=150, height=30))
        btn_add_cart = (Button(Add_CartWidgetsFrame, text="Add to Cart", command=self.add_update_cart,
                               font=("times new roman0", 15, "bold"), bg="orange", cursor="hand2")
        ...
        BTitle = (
            Label(billFrame, text="Customer Bill Area", font=("goudy old style", 20, "bold"), bg="#f44336", fg="white")
            .pack(side=TOP, fill=X))
        ...
        self.lbl_amnt = Label(billMenuFrame, text="Amount\n[0]", font=("goudy old style", 15, "bold"), bg="#3f51b5",
                              fg="white")
        ...
        # -----------------footer----------------------------------------
        footer = (Label(self.root, text="IMS- Inventory Management System", font=("times new roman", 11), bg="#4d636d",
                        fg="white")
                  .pack(side=BOTTOM, fill=X))
    ...
    def bill_updates(self):
        ...
        self.lbl_amnt.config(text=f'Bill Amnt(Tk.)\n{str(self.bill_amnt)}')
