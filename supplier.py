...
class SupplierClass:
    def __init__(self, root):
        ...
        #====title====
        title = Label(self.root, text="Employ Details", font=("goudy old style", 15), bg="#0f4d7d", fg="white").place(
        ...
        btn_add = Button(self.root, text="Update", font=("goudy old style", 15), bg="#4caf50", fg="white",
                         cursor="hand2").place(x=620, y=305, width=110, height=28)
        btn_add = Button(self.root, text="Delete", font=("goudy old style", 15), bg="#f44336", fg="white",
                         cursor="hand2").place(x=740, y=305, width=110, height=28)
        btn_add = Button(self.root, text="Clear", font=("goudy old style", 15), bg="#607d8b", fg="white",
